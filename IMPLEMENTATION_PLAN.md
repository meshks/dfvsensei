...
- Seed script: 8 demo `experiment_library` records (status='demo'), original summaries, covering interview/observation/concept-test/priced-offer/paid-pilot/benchmark/field-test/repeatability families so the window-cleaning fixture has real candidates in each DVF category.
